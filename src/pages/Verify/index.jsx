...
const Verify = () => {
  ...
  return (
    <section className="section py-10 min-h-screen bg-cover bg-center bg-no-repeat flex items-center"
      style={{ backgroundImage: "url('/OIP.webp')" }}>
      <div className="container">
        <div className="card shadow-md w-[500px]  m-auto mr-10 -mt-20 p-10 px-10 rounded-md bg-white p-10 px-10">
